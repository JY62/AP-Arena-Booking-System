...
BEGIN
    ...
    SELECT i.UserID, i.UserType, i.FullName, i.Email, i.PasswordHash, i.PhoneNumber, i.RegistrationDate, 'INSERT'
    FROM inserted i;

    -- Log updated records (UPDATE)
    INSERT INTO UserHistory (UserID, UserType, FullName, Email, PasswordHash, PhoneNumber, RegistrationDate, OperationType)
    SELECT u.UserID, u.UserType, u.FullName, u.Email, u.PasswordHash, u.PhoneNumber, u.RegistrationDate, 'UPDATE'
    FROM inserted i
    ...
    INSERT INTO UserHistory (UserID, UserType, FullName, Email, PasswordHash, PhoneNumber, RegistrationDate, OperationType)
    SELECT d.UserID, d.UserType, d.FullName, d.Email, d.PasswordHash, d.PhoneNumber, d.RegistrationDate, 'DELETE'
    FROM deleted d;
END;
GO
