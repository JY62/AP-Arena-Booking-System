...
('IC003', 'Individual Customers', ENCRYPTBYKEY(KEY_GUID('UserKey'), 'Jojo Siwa'), 'annoyingmf@example.com', HASHBYTES('SHA2_256', 'Cust0m3rP@ss3'), '+60178791261', GETDATE(), 'Active'),
('IC004', 'Individual Customers', ENCRYPTBYKEY(KEY_GUID('UserKey'), 'Siew Pui Yi'), 'MsPuiYi@example.com', HASHBYTES('SHA2_256', 'Cust0m3rP@ss4'), '+60178791261', GETDATE(), 'Active'),
('IC005', 'Individual Customers', ENCRYPTBYKEY(KEY_GUID('UserKey'), 'Maria Ozawa'), 'dayummmmm@example.com', HASHBYTES('SHA2_256', 'Cust0m3rP@ss5'), '+60196969696', GETDATE(), 'Active'),
('IC006', 'Individual Customers', ENCRYPTBYKEY(KEY_GUID('UserKey'), 'P Diddy'), 'PartyLover@example.com', HASHBYTES('SHA2_256', 'Cust0m3rP@ss6'), '+60123456789', GETDATE(), 'Active');
